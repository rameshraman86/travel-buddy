...
export default function Login({ email, handleSetEmail, setEmail, password, handleSetPassword, isExistingUser }) {
    ...
    <>
      <div className="flex mt-64 min-h-full flex-1 flex-col justify-center items-center px-6 pb-12 gap-12">
        ...
        <div>
          ...
          <div>
            Not registered yet? <Link className="text-amber-600" to='/signup'> Click here </Link> to register.
          </div>
        ...
        {/* <div className="flex justify-center items-center">
          <form className="space-y-2 flex gap-1">
