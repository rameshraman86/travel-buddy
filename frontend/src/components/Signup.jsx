...
export default function Signup() {
  return (
    <>
      ...
      <div>
        <form>
          {/* first name, last name, email, password, reenter password */}
          <input type="text" name="firstName" required placeholder="Enter your first name" />
          <input type="text" name="lastName" required placeholder="Enter your last name" />
          <input type="email" name="email" required placeholder="Enter your email" />
          <input type="password" name="password" required placeholder="Enter your password" />
          <input type="password" name="password" required placeholder="Re-enter your password" />
      ...
      <div>
        Already Registered? <Link className="text-amber-600" to='/login'> Click here </Link> to Login.
      </div>
