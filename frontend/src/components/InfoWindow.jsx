            ...
            <div className='my-1'>
              {itineraryItems.some(place => place.url === selectedPlace.url) ?
                ...
                (<div>
                  ...
                  <button className="flex items-center rounded-lg border border-transparent bg-amber-500 pr-4 pl-2 py-2 text-sm font-medium text-white shadow-sm hover:bg-amber-600 focus:outline-none gap-1 my-2"
